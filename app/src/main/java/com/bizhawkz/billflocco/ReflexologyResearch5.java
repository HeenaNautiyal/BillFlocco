...
public class ReflexologyResearch5 extends AppCompatActivity {
    Toolbar toolbar;
    WebView webView;
    ProgressDialog pb;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reflexology_research5);
        mySwipeRefreshLayout = (SwipeRefreshLayout) this.findViewById(R.id.swipeContainer);
        webView = (WebView) findViewById(R.id.web1);
        initToolBar();

        pb = new ProgressDialog(ReflexologyResearch5.this);
        pb.setMessage("Please wait while Loading...");
        pb.show();
        pb.setCancelable(false);

        webView.setWebViewClient(new MyWebViewClient());
        url = "http://www.reflexologyresearch.net/PMSResearchSymptoms.shtml";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ReflexologyResearch5.this);
                TextView myMsg = new TextView(ReflexologyResearch5.this);
    ...
    private void initToolBar() {
        ...
        toolbar.setTitle("PMS Reflexology Research Study:Psychological");
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent It = new Intent(ReflexologyResearch5.this, ResearchOption.class);
                        startActivity(It);
                    }
                });
    }
