...
public class AboutReflexology16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_reflexology16);
        mySwipeRefreshLayout = (SwipeRefreshLayout) this.findViewById(R.id.swipeContainer);
        webView = (WebView) findViewById(R.id.web1);
        initToolBar();

        pb = new ProgressDialog(AboutReflexology16.this);
        pb.setMessage("Please wait while Loading...");
        pb.show();
        pb.setCancelable(false);

        webView.setWebViewClient(new MyWebViewClient());
        url = "http://www.americanacademyofreflexology.com/reflexology-continuing-education-for-many-professions/";
    ...
    private void initToolBar() {
        ...
        toolbar.setTitle("REFLEXOLOGY CONTINUING EDUCATION FOR MANY PROFESSIONS");
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent It = new Intent(AboutReflexology16.this, ResearchOption.class);
                        startActivity(It);
                    }
                });
    }
