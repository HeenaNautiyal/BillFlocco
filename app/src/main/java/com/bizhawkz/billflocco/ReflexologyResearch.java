...
public class ReflexologyResearch extends AppCompatActivity {
    Toolbar toolbar;
    WebView webView;
    ProgressDialog pb;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pb = new ProgressDialog(ReflexologyResearch.this);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ReflexologyResearch.this);
                TextView myMsg = new TextView(ReflexologyResearch.this);
    ...
    private void initToolBar() {
        ...
        toolbar.setTitle("Reflexology Reaserch 380+Abstract from around the world");
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent It = new Intent(ReflexologyResearch.this, ResearchOption.class);
                        startActivity(It);
                    }
                });
    }
