    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://www.americanacademyofreflexology.com/national-level-reflexology-organizations-in-the-usa/";
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ReflexologyResource.this);
                TextView myMsg = new TextView(ReflexologyResource.this);
