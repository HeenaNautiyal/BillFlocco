...
public class ReflexologyResource7 extends AppCompatActivity {
    Toolbar toolbar;
    WebView webView;
    ProgressDialog pb;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reflexology_resource7);
        mySwipeRefreshLayout = (SwipeRefreshLayout) this.findViewById(R.id.swipeContainer);
        webView = (WebView) findViewById(R.id.web1);
        initToolBar();

        pb = new ProgressDialog(ReflexologyResource7.this);
        pb.setMessage("Please wait while Loading...");
        pb.show();
        pb.setCancelable(false);

        webView.setWebViewClient(new MyWebViewClient());
        url = "http://www.americanacademyofreflexology.com/discover-highly-absorbable-liquid-nutrients-for-better-health/";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ReflexologyResource7.this);
                TextView myMsg = new TextView(ReflexologyResource7.this);
    ...
    private void initToolBar() {
        ...
        toolbar.setTitle("Discover Highly Absorbable Liquid");
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent It = new Intent(ReflexologyResource7.this, ResourceOption.class);
                        startActivity(It);
                    }
                });
    }
