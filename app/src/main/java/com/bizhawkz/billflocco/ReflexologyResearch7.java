...
public class ReflexologyResearch7 extends AppCompatActivity {
    Toolbar toolbar;
    WebView webView;
    ProgressDialog pb;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pb = new ProgressDialog(ReflexologyResearch7.this);
        pb.setMessage("Please wait while Loading...");
        pb.show();
        pb.setCancelable(false);

        webView.setWebViewClient(new MyWebViewClient());
        url = "http://www.reflexologyresearch.net/HowToResearchCover.shtml";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ReflexologyResearch7.this);
                TextView myMsg = new TextView(ReflexologyResearch7.this);
    ...
    private void initToolBar() {
        ...
        toolbar.setTitle("Reflexology research A How to Book");
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent It = new Intent(ReflexologyResearch7.this, ResearchOption.class);
                        startActivity(It);
                    }
                });
    }
